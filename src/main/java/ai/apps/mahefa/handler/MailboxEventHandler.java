...
import static ai.apps.mahefa.concurrency.ThreadRenamer.renameWorkerThread;
import static java.lang.Runtime.getRuntime;
import static java.lang.System.getenv;
import static java.lang.Thread.currentThread;

import ai.apps.mahefa.PojaApplication;
import ai.apps.mahefa.PojaGenerated;
import ai.apps.mahefa.endpoint.EndpointConf;
import ai.apps.mahefa.endpoint.event.EventConf;
import ai.apps.mahefa.endpoint.event.consumer.EventConsumer;
import ai.apps.mahefa.endpoint.event.consumer.model.ConsumableEvent;
import ai.apps.mahefa.endpoint.event.consumer.model.ConsumableEventTyper;
