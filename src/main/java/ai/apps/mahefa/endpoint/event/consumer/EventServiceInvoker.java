package ai.apps.mahefa.endpoint.event.consumer;

import ai.apps.mahefa.PojaGenerated;
import ai.apps.mahefa.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("ai.apps.mahefa.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "ai.apps.mahefa.service.event."
