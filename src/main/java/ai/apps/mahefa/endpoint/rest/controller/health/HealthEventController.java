package ai.apps.mahefa.endpoint.rest.controller.health;

import static ai.apps.mahefa.endpoint.rest.controller.health.PingController.KO;
import static ai.apps.mahefa.endpoint.rest.controller.health.PingController.OK;
import static java.util.UUID.randomUUID;

import ai.apps.mahefa.PojaGenerated;
import ai.apps.mahefa.endpoint.event.EventProducer;
import ai.apps.mahefa.endpoint.event.model.DurablyFallibleUuidCreated1;
import ai.apps.mahefa.endpoint.event.model.DurablyFallibleUuidCreated2;
