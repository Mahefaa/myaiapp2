...
import static ai.apps.mahefa.file.hash.FileHashAlgorithm.NONE;
import static java.io.File.createTempFile;
import static java.nio.file.Files.createTempDirectory;
import static java.util.UUID.randomUUID;

import ai.apps.mahefa.PojaGenerated;
import ai.apps.mahefa.file.bucket.BucketComponent;
import ai.apps.mahefa.file.hash.FileHash;
import java.io.File;
