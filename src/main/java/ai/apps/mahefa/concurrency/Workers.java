package ai.apps.mahefa.concurrency;

import static ai.apps.mahefa.concurrency.ThreadRenamer.getRandomSubThreadNamePrefixFrom;
import static ai.apps.mahefa.concurrency.ThreadRenamer.renameThread;
